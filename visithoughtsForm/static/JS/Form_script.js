document.addEventListener('DOMContentLoaded', function() {
    ...
    sliders.forEach(function(sliderInfo) {
        ...
        const initialText = getValueText(initialValue);
        const initialColor = getValueColor(initialValue);

        document.querySelector(`.${sliderInfo.textClass}`).textContent = initialText;
        document.querySelector(`.${sliderInfo.textClass}`).style.color = initialColor;
